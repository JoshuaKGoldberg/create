...
describe("getRepositoryLocator", () => {
	it("throws an error when the options are missing owner", () => {
		...
		expect(() => {
			...
			`To run with --mode initialize, --owner must be a string-like, not undefined.`,
		);
	});
	...
	it("throws an error when the options have an invalid owner", () => {
		...
		expect(() => {
			...
			`To run with --mode initialize, --owner must be a string-like, not object.`,
		);
	});
	...
	it("throws an error when the options are missing repository", () => {
		...
		expect(() => {
			...
			`To run with --mode initialize, --repository must be a string-like, not undefined.`,
		);
	});
	...
	it("throws an error when the options have an invalid repository", () => {
		...
		expect(() => {
			...
			`To run with --mode initialize, --repository must be a string-like, not object.`,
		);
	});
