...
- Inputs APIs receive an [Input Context](#input-contexts)
- Options APIs receive an [Options Context](#options-contexts)
- Template APIs receive an [Template Context](#template-contexts)
