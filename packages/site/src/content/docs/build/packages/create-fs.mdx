...
The separate `create-fs` package includes types and utility functions for the file system used in [Concepts > Creations > `files`](/build/concepts/creations#files).
