...
- [`fetchers`](#fetcher-systems): sending network requests
- [`fs`](#file-systems): interacting with directories and files on disk
- [`runner`](#runner-systems): executing shell commands
