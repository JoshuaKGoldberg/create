...
As the production is run, the Bingo engine will add in additional creations from the template's [`setup()` method](/build/apis/create-template#transition), if it exists.
...
As the production is run, the Bingo engine will add in additional creations from the template's [`transition()` method](/build/apis/create-template#transition), if it exists.
