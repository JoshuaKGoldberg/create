...
It allows you to pull in great tooling from templates such as [`create-typescript-app`](https://github.com/JoshuaKGoldberg/Bingo-typescript-app) without needing to configure it all from scratch.
