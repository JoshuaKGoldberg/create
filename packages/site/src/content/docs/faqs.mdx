...
:::warning
TODO: This still needs to be updated post-76.
I'm going to write docs on the template systems, then link to them here.
:::
...
See [JoshuaKGoldberg/Bingo-typescript-app#1181 📝 Documentation: Long-term project vision](https://github.com/JoshuaKGoldberg/Bingo-typescript-app/issues/1181) for more history.
...
:::note
For more history on how Bingo came to be, see [JoshuaKGoldberg/Bingo-typescript-app#1181 📝 Documentation: Long-term project vision](https://github.com/JoshuaKGoldberg/Bingo-typescript-app/issues/1181).
:::
...
- Cookiecutter always operates at the scale of one template; Bingo provides more granular APIs for areas of features (Blocks and Presets)
...
- Copier always operates at the scale of one template; Bingo provides more granular APIs for areas of features (Blocks and Presets)
...
- degit always operates at the scale of a full repository; Bingo provides more granular APIs for areas of features (Blocks and Presets)
...
- Template Repositories always operate at the scale of a full repository; Bingo provides more granular APIs for areas of features (Blocks and Presets)
...
- Hygen templates are imperative descriptions of files and frontmatter; Bingo groups areas into blocks
...
<details>
<summary>More details on <code>Bingo</code> differing from projen</summary>
...
:::note
For more details on how Bingo compares to Projen, see [JoshuaKGoldberg/Bingo-typescript-app#1181 📝 Documentation: Long-term project vision#issuecomment-2428303689](https://github.com/JoshuaKGoldberg/Bingo-typescript-app/issues/1181#issuecomment-2428303689)
:::
