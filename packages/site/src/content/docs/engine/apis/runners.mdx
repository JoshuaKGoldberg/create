...
Given a [Template](../concepts/templates) and the name of one of its [Preset](../concepts/presets), executes a [Creation](../runtime/creations) output by running each of the Preset's Blocks' [`produce()`](../concepts/blocks#production).
