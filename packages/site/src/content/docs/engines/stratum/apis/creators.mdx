...
title: Stratum Creator APIs
---

The Stratum engine provides granular APIs for each of the layers:

- [`createBase`](#createbase): creates a new [Base](/engines/stratum/concepts/bases)
