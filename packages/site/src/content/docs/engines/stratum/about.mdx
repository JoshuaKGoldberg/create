...
:::tip
See [JoshuaKGoldberg/create-typescript-app](https://github.com/JoshuaKGoldberg/create-typescript-app) for an example of a repository template built with the Stratum templating engine.
:::
