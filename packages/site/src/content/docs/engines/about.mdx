...
2. **[Blocks](/engines/blocks/about)**: a rich system to define each feature of a template as an independent "blocks".
...
See **[Custom Engines](/engines/custom)** for more information.
